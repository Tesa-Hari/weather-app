...
function AboutPage() {
    return (
       ...
       {/* Grid - Cards */}
       <div className="bg-gradient-to-r from-violet-500 via-purple-400 to-violet-100 h-5/6">
            <div className="max-w-4xl mx-auto p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4" >
                    ...
                    <div className="p-6 bg-white rounded-3xl flex flex-col justify-evenly">
                        ...
                        <a href="#" className="text-center bg-violet-300 text-violet-700 py-2 rounded-lg font-semibold mt-4 hover:bg-violet-300 focus:scale-95 transition-all duration-200 ease-out">Explore</a>
                    </div>
                    ...
                    <div className="p-6 bg-white rounded-3xl flex flex-col justify-between">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 text-lg mt-2">Tesa is a dedicated software engineer with a passion for crafting robust and efficient web applications. With expertise in both frontend and backend development, Tesa excels in building scalable and performant solutions using modern technologies.</p>
                        </div>
                        <a href="https://github.com/YourGitHubUsername" target="_blank" rel="noopener noreferrer" className="text-center bg-violet-300 text-violet-700 py-2 rounded-lg font-semibold mt-4 hover:bg-violet-300 focus:scale-95 transition-all duration-200 ease-out">Explore</a>
                    </div>
