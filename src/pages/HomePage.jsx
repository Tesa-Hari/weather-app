...
function HomePage() {
    ...
    return (
        <>
            <section className=" pl-5 pr-5  w-100 text-lg flex flex-col flex-wrap sm:flex-nowrap py-1 overflow-x-hidden">
                <div className="w-fixed w-full flex-shrink flex-grow-0 px-4">
                    <div className=" flex flex-row flex-wrap justify-between sticky top-0 p-3 w-full h-full sm:flex-nowrap">
                        <div className=" flex flex-row flex-wrap">
                            <img src={seasons} alt="Logo" className="h-14 mr-4" /><span className="text-purple-500 text-3xl smmax:text-2xl">Weather<span className="text-gray-500">Wise</span></span>
                        </div>
                        <div className="text-lg font-semibold leading-6 text-gray-900 smmax:hidden ">
                        ...
                        <div className="sm:hidden  smmax:mt-2">
                            <FontAwesomeIcon className=" w-10 h-10" icon={faHamburger} onClick={() => { setToggle(!toggle) }} />
                            {toggle && <nav className="flex flex-col jsutify-evenly absolute" >
                                <NavLink to="/" className=" p-2 text-white bg-purple-500 border border-white" >Home </NavLink>
                                <NavLink to="/about" className="p-2 text-white bg-purple-500 border border-white">About  </NavLink>
                                <NavLink to="/createweekly/" className="p-2 text-white bg-purple-500 border border-white">Add Forecast </NavLink>
                            </nav>}
                        </div>
                ...
                <div className="p-2 mt-4 mb-4 overflow-x-hidden ">
