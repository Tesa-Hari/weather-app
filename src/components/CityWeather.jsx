  ...
  return (
    <>
      <section className="bg-gray-50 mb-5">
        <h2 className="text-center p-5 text-2xl font-bold text-purple-400 smmax:text-sm ">Explore Top Destinations Recommended by Our Weather Forecast</h2>
        <div className="mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-24">
          <div className="grid grid-cols-1 gap-8 grid-cols-3 items-center lg:gap-8">
            {cityArray.map((city, index) => (
              <div key={index} className="-mx-6 mx-0  ">
                  ...
                  <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12">
                    <div>
                      ...
                      <div className="mt-4">
                        ...
                        <p className="mt-4 leading-relaxed text-violet-500 text-2xl">
                          {cityTemp[index]}°
                        </p>
                      </div>
                    </div>
